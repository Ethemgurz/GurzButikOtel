...
/*FrmOdalar_Load olayı, form yüklendiğinde çalışır ve veritabanından her bir oda için müşteri bilgilerini getirir. Ardından, odanın durumuna göre ilgili butonun metnini ve arka plan rengini ayarlar.
Her bir oda için ayrı ayrı SQL sorguları (SELECT) kullanılarak müşteri bilgileri çekilir. Bu bilgiler, oda numarası ve müşterinin adı/soyadı şeklinde gösterilir.
Odaların dolu veya boş olup olmadığına göre, ilgili butonların arka plan rengi ayarlanır. Eğer bir oda doluysa, butonun rengi kırmızıya dönüştürülür; boşsa yeşil olur.*/
